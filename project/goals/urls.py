...
urlpatterns = [
    ...
    path("table/<int:year>/<int:month>/", views.Table.as_view(), name="month_table"),
    path("table/<int:year>/", views.Table.as_view(), name="year_table"),
    path("year/", views.Year.as_view(), name="index_year"),
